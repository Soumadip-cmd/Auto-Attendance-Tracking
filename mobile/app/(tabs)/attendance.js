...
export default function AttendanceScreen() {
  ...
  const renderHeader = () => <View>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={handleNextMonth} style={styles.monthButton} disabled={isCurrentMonth()}>
          <Ionicons name="chevron-forward" size={24} color={isCurrentMonth() ? theme.colors.border : theme.colors.text} />
        </TouchableOpacity>
      </View>
