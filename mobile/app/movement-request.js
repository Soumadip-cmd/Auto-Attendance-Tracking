    ...
    backgroundColor: theme.colors.background
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        borderColor: theme.colors.border
          ...
          <TextInput value={reason} onChangeText={setReason} multiline numberOfLines={4} textAlignVertical="top" placeholder="Urgent work, department visit, exam duty..." placeholderTextColor={theme.colors.textSecondary} style={[styles.input, styles.textArea, {
          color: theme.colors.text,
          borderColor: theme.colors.border,
          backgroundColor: theme.colors.background
        }]} />
          ...
          <TouchableOpacity onPress={captureLocation} style={[styles.secondaryButton, {
          ...
          <TouchableOpacity onPress={submitRequest} disabled={submitting} style={[styles.primaryButton, {
