  ...
  return <View style={[styles.container, {
    backgroundColor: theme.colors.background
      ...
      borderBottomColor: theme.colors.border
        ...
        <Button variant="ghost" onPress={() => router.back()} icon={<Ionicons name="arrow-back" size={24} color={theme.colors.text} />} />
      ...
      }]}>Last updated: December 20, 2025</Text>
